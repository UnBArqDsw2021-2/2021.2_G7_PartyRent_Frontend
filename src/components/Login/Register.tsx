            ...
            <div className="container">
                <div className="content first-content">
                    <div className="first-column">
                        ...
                        <Link to="/login">
                            <button className="btn-cadastro btn-primary">entrar</button>
                        </Link>
                    </div>
                    <div className="second-column">
                        ...
                        <form className="form">
                            ...
                            <label className="label-input">
                                <i className="fas fa-lock icon-modify"></i>
                                <input type="tel" required placeholder="(99) 99999-9999" maxLength={11}/>
                            </label>

                            <button className="btn-cadastro btn-second">registrar</button>
                        </form>
                    </div>
                </div>
            </div>
